...
class rBox1NoUserModule(tornado.web.UIModule):
    def render(self):
        return self.render_string('modules/rbox1_no_user.html')

class rBox1UserModule(tornado.web.UIModule):
    def render(self, user):
        return self.render_string('modules/rbox1_user.html', user=user)

class top3NoUserModule(tornado.web.UIModule):
    def render(self):
        return self.render_string('modules/top3_no_user.html')

class top3UserModule(tornado.web.UIModule):
    def render(self, user):
        return self.render_string('modules/top3_user.html', user=user)

class secNavModule(tornado.web.UIModule):
    def render(self, sections):
        return self.render_string('modules/sec_nav.html', sections=sections)

class rBox2Module(tornado.web.UIModule):
    def render(self, forum, wealthList):
        return self.render_string('modules/rbox2.html', forum=forum, wealthList=wealthList)
...
def main():
    ...
    settings = {
        ...
        'ui_modules': {
            'Post': PostModule,
            'Reply': ReplyModule,
            'rBox1NoUser': rBox1NoUserModule,
            'rBox1User': rBox1UserModule,
            'rBox2': rBox2Module,
            'top3NoUser': top3NoUserModule,
            'top3User': top3UserModule,
            'secNav': secNavModule,
        },
        'debug': True
    }
